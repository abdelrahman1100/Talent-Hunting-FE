...
const CategoryListSelected = () => {
    const { deleteCategories, loading, error, success } = useDeleteCategory()
...
try {
      deleteCategories(categoryList, selectedCategory, (newList) => {
     mutate(
            {
                list: newList,
    ...
    return (
        <>
            ...
            >
                <p>
                    {' '}
                    Are you sure you want to remove these Category? This action
                    can&apos;t be undo.{' '}
                </p>
            </ConfirmDialog>
