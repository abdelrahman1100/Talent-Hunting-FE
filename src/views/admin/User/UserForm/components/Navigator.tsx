...
const navigationList = [
   {
        label: 'Company Commercial ID',
        description: 'Provide company commercial ID details.',
        link: 'companyImage',
        icon: <TbMapPin />,
    },
        {
        ...
        description:
            'Enter company information like name, location',
        link: 'companyInformation',
        icon: <TbUserSquare />,
    },
    {
        label: 'Select Category',
        description: 'Select Category To Your Company',
        link: 'selectedCategories',
        icon: <TbPackage />,
    },
